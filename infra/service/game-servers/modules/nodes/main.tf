module "ark_node_group" {
    ...
    instance_type = "c6i.xlarge" // "c6i.8xlarge" for 3 Ark servers. c6i.4xlarge for three Minecraft servers, vanilla + pixelmon + gregtech. c6i.xlarge for one minecraft server.
