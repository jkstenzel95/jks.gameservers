                ...
                if game["name"] == "Valheim":
                    ...
                    for idx, map_info in enumerate(mappings_json["maps"]):
                        ...
                        if map in map_set:
                            ...
                            ports.append({ "name": "{}_SERVERPORT2_UDP".format(port_name_prefix), "protocol": "UDP", "number": game_port, "game": "Valheim", "map": map })
                            ports.append({ "name": "{}_SERVERPORT3_UDP".format(port_name_prefix), "protocol": "UDP", "number": game_port, "game": "Valheim", "map": map })
