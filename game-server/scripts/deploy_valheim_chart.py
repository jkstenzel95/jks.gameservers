                ...
                if game["name"] == "Valheim":
                    ...
                    for idx, map_info in enumerate(mappings_json["maps"]):
                        ...
                        if map in map_set:
                            ...
                            values_string = "--set imageTag={},game=Valheim,map={},mapSet={},volumeId={},requestsMemory={},limitsMemory={},environmentVariableFile={},{}".format(image_version, map, map, map_info["volumeId"], map_info["requestsMemory"], map_info["limitsMemory"], env_file, gp_port_string)
