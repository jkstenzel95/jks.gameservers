...
echo "{ \"Comment\": \"Create an alias to map ${subdomain} to ${ip}\", \"Changes\": [{ \"Action\": \"UPSERT\", \"ResourceRecordSet\": { \"Name\": \"${subdomain}\", \"Type\": \"A\", \"TTL\": 300, \"ResourceRecords\": [{ \"Value\": \"${ip}\"}]}}] }" > operation.json
