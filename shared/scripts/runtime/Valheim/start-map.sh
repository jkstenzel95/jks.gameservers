...
SERVER_PASSWORD=$(cat /mnt/secrets-store/jks_gameservers_${ENVIRONMENT}_${REGION_SHORTNAME}_Valheim-Server-Password | jq '.["jks/gameser
vers/${ENVIRONMENT}/${REGION_SHORTNAME}/Valheim-Server-Password"]' | tr -d '"')
